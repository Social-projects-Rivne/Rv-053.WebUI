  ...
  return ( <
    React.Fragment > {
      notificationState.show ? ( <
        Notificator className = "auth alert alert-danger p-0"
        message = {
    ...
    <
    div className = "mt-3 d-inline-block float-left"
    style = {
      {
        width: '45%',
    ...
    <
    /div> <
    p className = "d-inline-block text-center mb-0"
    style = {
      {
        width: '10%'
      }
    ...
    OR <
    /p> <
    div className = "mt-3 d-inline-block float-right"
    style = {
      {
        width: '45%',
        borderTop: '1px solid #999',
