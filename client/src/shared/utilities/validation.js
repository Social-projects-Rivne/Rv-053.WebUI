...
export const VAL_REQUIRED = () => ({
	valType: REQ_REQUIRED
});
export const VAL_EMAIL = () => ({
	valType: REQ_EMAIL
});
export const VAL_LETTERS = () => ({
	valType: REQ_LETTERS
});
export const VAL_NUMBERS = () => ({
	valType: REQ_NUMBERS
});
export const VAL_PASSWORD = (length, keys) => ({
	valType: REQ_PASSWORD,
	length,
	keys
});
