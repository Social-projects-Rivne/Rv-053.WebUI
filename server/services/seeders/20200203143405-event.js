    ...
    return queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          owner_id: 1,
          description:
            'На бізнес-ланчі з Вітою Кравчук будемо говорити на тему масштаба власника бізнесу',
        ...
        },
        {
          ...
          owner_id: 2,
          description:
            'Сахаджа Йога - це унікальний і природний спосіб досягнення самореалізації, який веде до внутрішнього просвітлення.',
          location: 'Rivne, Soborna str',
          datetime: '1980-06-17',
          duration: 120,
          max_participants: 30,
        ...
        },
        {
          ...
          owner_id: 1,
          description:
            'The most difficult is to achieve everyday goals. This is what Toastmasters about: self-development, self-improvement, and self-realization. If you follow Toastmasters educational program',
